...
public class Person {
  ...
  //  FlawFound: hashCode does not include yearOfBirth, which is used in equals
  //  FlawFixToDo: Include yearOfBirth in the hashCode calculation
  //  FlawFixed: Now includes yearOfBirth in hashCode calculation
}
