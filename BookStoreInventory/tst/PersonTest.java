...
public class PersonTest {
  ...
  /**
   * Verify that overridden equals method works as expected, depending on key fields Creates several
   * additional local Persons to supplement those defined above
   */
  @Test
  ...
  // FlawFound: Missing test for equality on same reference object.
  // FlawFixed: Added assertEquals for same reference object check.
  // FlawFixToDo: Confirm equals method evaluates same reference objects correctly.


  /**
   * Verify that overridden hashCode returns same int for equal Persons Important to honor contract
