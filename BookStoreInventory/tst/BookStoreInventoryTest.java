...
public class BookStoreInventoryTest {
  ...
  // FlawFound: assertNotEquals(book0, mag1) irrelevant for testing add method.
  // FlawFixToDo: Remove assertNotEquals(book0, mag1).
  // FlawFixed: Removed unnecessary assertNotEquals statement.
